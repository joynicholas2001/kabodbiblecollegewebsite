...
export default function AnnouncementBar() {
  ...
  return (
    <div className="bg-brand-purple text-white py-1.5 overflow-hidden whitespace-nowrap border-b border-brand-gold/25 relative z-[60] shadow-sm transition-colors duration-300 ease-in-out">
