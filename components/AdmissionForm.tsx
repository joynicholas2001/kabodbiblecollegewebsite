    ...
    >
      ...
      <div className="mt-8">
        <button
          ...
          className="w-full rounded-lg bg-brand-purple px-6 py-4 font-semibold text-white shadow-md hover:bg-brand-purple-dark focus:outline-none focus:ring-2 focus:ring-brand-accent focus:ring-offset-2 disabled:opacity-70 disabled:cursor-not-allowed transition-all duration-300 ease-in-out"
        >
