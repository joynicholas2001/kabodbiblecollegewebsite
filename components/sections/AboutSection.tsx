...
export default function AboutSection() {
  return (
    <section className="py-[60px] bg-brand-soft">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          {/* Visual / Scripture block */}
          <div className="relative order-2 lg:order-1">
            <div className="aspect-[4/3] rounded-3xl bg-gradient-to-br from-brand-purple-dark to-brand-secondary overflow-hidden shadow-2xl">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="rounded-2xl bg-brand-card border-0 p-6 shadow-card">
              <h3 className="font-heading font-bold text-brand-purple text-lg mb-2">
                What does &ldquo;Kabod&rdquo; mean?
              </h3>
              <p className="text-brand-purple leading-relaxed">
                <strong className="text-brand-purple">Kabod</strong> (כָּבוֹד,
                <em className="text-brand-muted"> Kāḇôḏ</em>) is the Hebrew word
