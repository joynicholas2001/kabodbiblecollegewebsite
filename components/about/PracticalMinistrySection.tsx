  ...
  return (
    <section className="bg-brand-light py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="bg-brand-card/35 rounded-3xl p-8 sm:p-12 shadow-card border border-brand-card flex flex-col sm:flex-row items-center gap-8 sm:gap-12 relative overflow-hidden group hover:border-brand-gold/30 transition-colors">
            {/* Edge highlight */}
