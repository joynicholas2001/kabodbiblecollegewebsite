...
export default function GoalSection() {
  ...
  return (
    <section className="bg-brand-light py-12 sm:py-16 border-t border-brand-card">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {goals.map((goal, i) => (
              <motion.div
                ...
                className="flex items-center gap-4 bg-brand-card/25 p-6 rounded-xl border border-brand-card hover:border-brand-gold/30 hover:shadow-card transition-all group"
              >
                ...
                <span className="text-lg font-semibold text-brand-purple-dark">
                  {goal}
                </span>
              </motion.div>
            ))}
