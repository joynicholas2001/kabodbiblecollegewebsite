...
export default function AboutPrayerSection() {
  return (
    <section className="relative bg-gradient-to-br from-brand-purple to-brand-purple-dark py-16 sm:py-20">
      <div className="absolute inset-0 bg-brand-purple-dark/35" />
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="rounded-2xl border border-white/20 bg-brand-purple-dark/35 backdrop-blur-sm p-6 sm:p-8"
          >
