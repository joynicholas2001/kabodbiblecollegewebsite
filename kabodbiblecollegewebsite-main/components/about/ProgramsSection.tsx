        ...
        >
          {SUBJECTS.map((subject) => (
            <motion.div
              key={subject}
              variants={cardItem}
              className="rounded-xl border-2 border-gray-100 bg-white p-5 shadow-sm transition-all duration-300 hover:border-brand-purple/30 hover:shadow-lg hover:shadow-brand-purple/5"
            >
