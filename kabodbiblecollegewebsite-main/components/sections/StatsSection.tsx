      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {stats.map(({ icon: Icon, value, label, description }) => (
            <div
              key={label}
              className="group relative rounded-2xl bg-gray-50 border border-gray-100 p-6 sm:p-8 text-center transition-all duration-300 hover:border-brand-purple/20 hover:shadow-lg hover:shadow-brand-purple/5"
            >
              ...
              <p className="mt-2 font-semibold text-gray-900 text-lg">{label}</p>
