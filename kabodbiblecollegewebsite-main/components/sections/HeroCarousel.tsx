    ...
    <section className="relative w-full">
      ...
      >
        {slides.map((slide) => (
          <SwiperSlide key={slide.id}>
            <div
              className={`relative w-full min-h-[85vh] sm:min-h-[90vh] flex items-center justify-center bg-cover bg-center ${SLIDE_FALLBACK_CLASS}`}
              style={{
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-t ${slide.overlay} to-transparent`}
              />
            </div>
          </SwiperSlide>
        ))}
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center pointer-events-none">
        <div className="relative text-center px-4 sm:px-6 max-w-4xl mx-auto">
          ...
          <p className="mt-4 sm:mt-6 text-lg sm:text-xl md:text-2xl text-white/95 font-medium max-w-2xl mx-auto leading-relaxed pointer-events-auto">
            {heroSubtitle}
          </p>
          <div className="mt-8 sm:mt-10 flex flex-wrap justify-center gap-4 pointer-events-auto">
            <Link
              href="/admission"
      ...
      <button
        ...
        className="hero-swiper-prev absolute left-4 sm:left-6 top-1/2 -translate-y-1/2 z-40 w-12 h-12 rounded-full bg-white/15 hover:bg-white/25 backdrop-blur-sm border border-white/30 flex items-center justify-center text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-gold"
      >
        <svg
          className="w-5 h-5"
          fill="none"
      ...
      <button
        ...
        className="hero-swiper-next absolute right-4 sm:right-6 top-1/2 -translate-y-1/2 z-40 w-12 h-12 rounded-full bg-white/15 hover:bg-white/25 backdrop-blur-sm border border-white/30 flex items-center justify-center text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-brand-gold"
      >
        <svg
          className="w-5 h-5"
          fill="none"
